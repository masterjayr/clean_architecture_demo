...
class NumberTriviaBlocBloc
    extends Bloc<NumberTriviaBlocEvent, NumberTriviaBlocState> {
  final GetConcreteNumberTrivia getConcreteNumberTrivia;
  final GetRandomNumberTrivia getRandomNumberTrivia;
  final InputConverter inputConverter;

  NumberTriviaBlocBloc(
      {@required GetConcreteNumberTrivia concrete,
      @required GetRandomNumberTrivia random,
      @required this.inputConverter}):assert(concrete !=null),
                                      assert(random !=null),
                                      assert(inputConverter !=null),
                                        getConcreteNumberTrivia = concrete,
                                        getRandomNumberTrivia = random;
  @override                           
  NumberTriviaBlocState get initialState => Empty();
  ...
  Stream<NumberTriviaBlocState> mapEventToState(
    ...
    yield* inputEither.fold((failure) async*{
       ...
       yield* _eitherFailureOrSuccess(failureOrTrivia);
     });
  ...
  Stream<NumberTriviaBlocState> _eitherFailureOrSuccess(Either<Failure, NumberTrivia> failureOrTrivia) async* {
